...
#SBATCH --mem 100g
#SBATCH --gres=gpu:a100-sxm4-80gb:1        # 申请 4 卡 A100 80GB，如果只申请CPU可以删除本行
...
model_name_or_path=/home/jhguo/Downloads/Meta-Llama-3-8B-Instruct
output_dir=/home/jhguo/Code/NLU_eval_for_upload/results/llama3
